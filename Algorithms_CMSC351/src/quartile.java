...
//				System.out.println("temp: "+temp);
			...
			if(val > maxTop){//easy peasy
				MinHeap.insert(val);
			}else{//we need to add it to the maxheap, and add the curr top of maxheap to the min heap
				int temp = maxTop;
				MaxHeap.remove();
				MaxHeap.insert(val);
				MinHeap.insert(temp);				
		...
		if(MaxHeap.totElem+MinHeap.totElem != count){
			System.out.println("val: "+val);
			System.out.println("MinHeap contains?: "+MinHeap.minHeap.contains((Integer)val));
			System.out.println("MaxHeap contains?: "+MaxHeap.maxHeap.contains((Integer)val));
			System.out.println("MAXHEAP: ");
			MaxHeap.printTree();
			System.out.println("MaxHeap Total Elements: "+MaxHeap.totElem);
			System.out.println("MINHEAP: ");
			MinHeap.printTree();
			System.out.println("MinHeap Total Elements: "+MinHeap.totElem);
...
//				System.out.println("m");
		...
		while(maxHeap.contains(topVal)){
			maxHeap.remove((Integer)topVal);
			//System.out.println("REMOVED "+topVal+" from MAXHEAP");
		}
//	System.out.println("MaxHeap: ");
//	printTree();
	}
...
//			printTree();
		...
		public static void remove(){
			int swapIndex = 0, tempI, tempVal, topVal = minHeap.get(0);
...
//					System.out.println("m");
			...
			while(minHeap.contains(topVal)){
				minHeap.remove((Integer)topVal);
			}
//			System.out.println("MinHeap: ");
//			printTree();
		}
